...
module TerrainBufferGeometry {
    export function build(width: number, height: number, widthSegments: number, heightSegments: number, heightFunc: (x: number, y: number) => number) {
